...
close all 
clc, clear
% Import data from dataSet3.csv file
...
y = histogram(data0,10);
hold on, y2 = histogram(data1,10);
title('Data Set 3 probability density function')
legend('pdf of class 0','pdf of class 1')
%%
%---------
% part (a)
% LDA Model
...
x1 = linspace(-10, 40, 500);
x2 = linspace(-10, 30, 500);
